...
const routing = async (otvetGoogleNewsAPI) => {
  if (otvetGoogleNewsAPI.status === 'ok') {
    ...
    for (let i = 0; i < otvetGoogleNewsAPI.articles.length; i++) {
      ...
      break;
      case 'Ua-football.com':
        allArticlesUaFootball.push(elementMassivu);
      break;
      case 'Sportnews.com.ua':
...
*/    
    const daniNaPovernennia   = allAnotherArticles.concat(resultsFootball24UA, results24tvUA, resultsSportUA, resultsUaFootball, resultsGlavcomUA, resultsKievUA);
